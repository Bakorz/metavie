 ...
 * This class serves as the parent for all specific media types (Anime, Movie, TVShow).
 * It contains common properties shared by all media items such as title, description,
 * rating, and images.
 */
public abstract class MediaItem {
    ...
    /** Detailed description or synopsis of the media item */
    protected String description;
    
    /** List of genres associated with the media item */
    protected List<String> genres;
    
    /** Rating score of the media item (typically 0-10) */
     ...
     * 
     * @return String representing the media type (e.g., "ANIME", "MOVIE", "TV_SHOW")
     */
    /**
     * Abstract method to get the type of media.
     * Must be implemented by subclasses to return their specific type.
     ...
     * 
     * @param title Media title to set
     */
    ...
    /**
     * Gets the description or synopsis of the media item.
     * 
    ...
    /**
     * Sets the description or synopsis of the media item.
     * 
     * @param description Media description to set
     */
     ...
     * 
     * @return Rating score (typically 0-10)
     */
     ...
     * 
     * @param rating Rating score to set
     */
     ...
     * 
     * @return Release date as a string
     */
    ...
    /**
     * Gets the URL to the poster image.
     * 
    ...
    /**
     * Sets the URL to the poster image.
     * 
    ...
    /**
     * Gets the URL to the backdrop/banner image.
     * 
    ...
    /**
     * Sets the URL to the backdrop/banner image.
     * 
     ...
     * 
     * @return String containing basic media information
     */
    @Override
